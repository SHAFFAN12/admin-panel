...
let i=0
  ...
  return (
    <div className="data">
      <h1 className='product-heading'>Entered User Details</h1>
      <div className='center'>
        <div className='outer Button'>
      <button onClick={handleDataEntry} >Add New</button>
      <span></span>
      <span></span>
      </div>
        </div>
              ...
              <tr key={index}>
                ...
                <td>
                  <button
                    ...
                    className="btn btn-primary bg-green-400 text-white rounded-xl p-3"
                  >
                    Edit
                  </button>
                </td>
                <td>
                  <button
                    ...
                    className="btn btn-danger  bg-red-400 text-white rounded-xl p-3"
                  >
                    Delete
                  </button>
                </td>
  ...
  <p className='paragraph' totaluser={data.length}>Total Users: {data.length}</p>            
    <Dashboard className='scroll-ms-6 ' totaluser={data.length}/>
    </div>
  );
